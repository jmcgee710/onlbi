...
export const entertainment: Business[] = [
  ...
  // Parks & Nature — May 2026
  {
    ...
    phone: '(609) 494-2016', web: 'https://dep.nj.gov/parksandforests/state-park/barnegat-lighthouse-state-park/', icon: '🏛️',
  ...
  },
  {
    ...
    web: 'https://barnegatlight.org/gallery/parks-and-recreation/', icon: '🌿',
  ...
  },
  {
    ...
    phone: '(609) 290-0782', web: 'https://shipbottom.org/government/departments/parks-recreation/', icon: '⛵',
  ...
  },
  {
    ...
    web: 'https://beachhaven-nj.gov/departments/recreation/municipal-playgrounds/', icon: '🏓',
  ...
  },
  {
    ...
    phone: '(609) 492-0111', web: 'https://beachhaven-nj.gov/departments/recreation/beach-information/', icon: '🐕',
  ...
  },
  {
    ...
    web: 'https://beachhaven-nj.gov/departments/recreation/municipal-ramp/', icon: '🚤',
  ...
  },
  {
    ...
    phone: '(609) 652-1665', web: 'https://www.fws.gov/refuge/edwin-b-forsythe', icon: '🦅',
